...
sudo acbuild label add version "9"
...
sudo acbuild set-exec -- /bin/bash -c "git clone https://github.com/THS-on/lernstickAdvanced /lernstickCI && cd /lernstickCI && git checkout debian9-ci && ./build_dvd.sh -c ./container/constants.ci"
